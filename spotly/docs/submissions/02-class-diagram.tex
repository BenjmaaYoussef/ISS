...
The Spotly data model consists of \textbf{nine entity classes} persisted in
...
\begin{tabularx}{\linewidth}{llX}
    ...
    ReservationLog  & \texttt{spotly\_reservation\_logs} & Immutable audit trail; \texttt{actorRole}: client $|$ admin $|$ staff \\
