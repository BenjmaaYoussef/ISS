...
const _seed = [
  new User({ first_name: 'John', last_name: 'Doe', email: 'john.doe@example.com', password: 'password123' }),
...
export const USER_LIST = reactive(_saved ? JSON.parse(_saved).map(u => new User(u)) : _seed)
