<template>
  <div class="onboarding-root">
    ...
    <div class="ob-header">
      <div class="ob-logo">
        <v-icon size="18" color="#D4AF37" class="mr-2">mdi-map-marker-star-outline</v-icon>
        ...
        <div v-if="step === 1" key="step1">
          ...
          <div class="ob-actions">
            <button class="gold-btn ob-cta" @click="nextStep">
              Continue
              <v-icon size="15" class="ml-2">mdi-arrow-right</v-icon>
            </button>
          </div>
        </div>
        ...
        <div v-else-if="step === 2" key="step2">
          ...
          <div class="ob-actions">
            ...
            <button class="gold-btn ob-cta" :disabled="finishing" @click="finish">
              <v-progress-circular v-if="finishing" indeterminate size="14" width="2" color="white" class="mr-2" />
              Launch my venue
              <v-icon v-if="!finishing" size="15" class="ml-2">mdi-rocket-launch-outline</v-icon>
            </button>
          </div>
        </div>
      </transition>
